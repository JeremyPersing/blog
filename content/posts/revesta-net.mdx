...
Earlier in 2024 I decided to redesign the website and rename it to EquitiesList.com (because what the heck is a revesta?). In the upcoming year, I'm going to shut the site down, mostly because
I do not want to pay for the data to keep the site up to date. The site is fully automated, so there is no overhead, but I don't find myself using the website that much anymore. In fact, I don't find myself
looking at companies to invest in much anymore. I've found a few companies that I put some money into each paycheck, and then I put the rest into an index fund. I prefer this simplified investment approach.

I also did not market the website effectively and thus do not have a paying user base to sustain the cost of the site (which is not that much). So these are the reasons I'll be shutting down the website, but this was
still a good learning experience.

Below are some pictures of how the website currently looks.

![Screener alt](/equitieslist/1.png "Screener alt")
![Screener for desktop](/equitieslist/2.png "Screener for desktop")
![Filters for screener](/equitieslist/2_5.png "Filters for screener")
![Columns for screener](/equitieslist/2_6.png "Columns for screener")
![Company details](/equitieslist/3.png "Company details")
![Company details pt 2](/equitieslist/4.png "Company details pt 2")
![Company details pt 3](/equitieslist/5.png "Company details pt 3")
